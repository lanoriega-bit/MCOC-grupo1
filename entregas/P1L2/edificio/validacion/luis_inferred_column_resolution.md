...
| UNRESOLVED_REQUIRES_REVIEW | 19 |

## Supports
| Classification | Count |
| --- | ---: |
| INVALID_DERIVED_ELEMENT | 15 |
| UNRESOLVED_DERIVED_ELEMENT | 19 |
...
| 4 | OUTBOARD_DETAIL_SYMBOLS_IMPORTED_AS_COLUMNS_REVIEW | medium | P1:None from C_P1_01_0020, P1:None from C_P1_01_0021, P1:None from C_P1_01_0023 |
...
| E1-P2-C-013 | P2 | 20.0 | 20.451 | inferred_from_above_3 | UNSUPPORTED_VERTICAL_EXTENSION | outboard of confirmed Y3 axis; no same-floor RLE-PILAR match; no foundation RLE-PILAR/pedestal match; CALIBRATION_CAVEAT_DO_NOT_USE_AS_DEFECT |
| E1-P2-C-017 | P2 | 30.0 | 20.451 | inferred_from_above_3 | UNSUPPORTED_VERTICAL_EXTENSION | outboard of confirmed Y3 axis; no same-floor RLE-PILAR match; no foundation RLE-PILAR/pedestal match; CALIBRATION_CAVEAT_DO_NOT_USE_AS_DEFECT |
